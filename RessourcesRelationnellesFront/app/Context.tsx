...
interface UserContextType {
  user: User | null;            //Way of putting an if condition in a variable declaration = Current user if logged in, null if not logged in
  login: (user: User) => void;  //Function to log user in
